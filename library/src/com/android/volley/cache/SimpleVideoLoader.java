...
import com.android.volley.toolbox.VideoLoader;
 ...
 */
public class SimpleVideoLoader extends VideoLoader {
     ...
     */
    public SimpleVideoLoader(FragmentActivity activity) {
     ...
     * while the image is being fetched and loaded.
     */
    public SimpleVideoLoader(FragmentActivity activity, ImageCacheParams imageCacheParams) {
     ...
     */
    public SimpleVideoLoader(FragmentActivity activity, int defaultPlaceHolderResId, ImageCacheParams imageCacheParams) {
        super(newRequestQueue(activity,imageCacheParams),
                BitmapImageCache.getInstance(activity.getSupportFragmentManager(), imageCacheParams),
                activity.getResources());
     ...
     */
    public SimpleVideoLoader(FragmentActivity activity, ArrayList<Drawable> placeHolderDrawables, ImageCacheParams imageCacheParams) {
        super(newRequestQueue(activity, imageCacheParams),
                BitmapImageCache.getInstance(activity.getSupportFragmentManager(), imageCacheParams),
                activity.getResources());
     ...
     * image is being fetched and loaded.
     */
    public SimpleVideoLoader(Context context, int defaultPlaceHolderResId, ImageCacheParams imageCacheParams) {
     ...
     * Creates an ImageLoader with Bitmap memory cache and a list of default placeholder drawables.
     */
    public SimpleVideoLoader(Context context, ArrayList<Drawable> placeHolderDrawables, ImageCacheParams imageCacheParams) {
        super(newRequestQueue(context, imageCacheParams),
                BitmapImageCache.getInstance(null, imageCacheParams),
                context.getResources());
        mPlaceHolderDrawables = placeHolderDrawables;
	...
	public SimpleVideoLoader setFadeInImage(boolean fadeInImage) {
        mFadeInImage = fadeInImage;
        return this;
    }

    public SimpleVideoLoader setMaxImageSize(int maxImageWidth, int maxImageHeight) {
        mMaxImageWidth = maxImageWidth;
        mMaxImageHeight = maxImageHeight;
        return this;
    }

    public SimpleVideoLoader setMaxImageSize(int maxImageSize) {
    ...
    //Get 
    public VideoContainer get(String requestUrl, ImageView imageView) {
        return get(requestUrl, imageView, 0);
    }
    
    public VideoContainer get(String requestUrl, ImageView imageView, int maxImageWidth, int maxImageHeight) {
        return get(requestUrl, imageView, mPlaceHolderDrawables != null ? mPlaceHolderDrawables.get(0) : null, maxImageWidth, maxImageHeight);
    }

    public VideoContainer get(String requestUrl, ImageView imageView, int placeHolderIndex) {
    ...
    public VideoContainer get(String requestUrl, ImageView imageView, Drawable placeHolder) {
    ...
    public VideoContainer get(String requestUrl, ImageView imageView, Drawable placeHolder,
        ...
        // recycled)
        VideoContainer VideoContainer = imageView.getTag() != null &&
                imageView.getTag() instanceof VideoContainer ?
                (VideoContainer) imageView.getTag() : null;

        // Find image url from prior request
        String recycledImageUrl = VideoContainer != null ? VideoContainer.getRequestUrl() : null;
        ...
        if (requestUrl == null || !requestUrl.equals(recycledImageUrl)) {
            if (VideoContainer != null) {
                ...
                VideoContainer.cancelRequest();
                imageView.setTag(null);
            }
            if (requestUrl != null) {
                // Queue new request to fetch image
                VideoContainer = get(requestUrl,
                        getVideoListener(getResources(), imageView, placeHolder, mFadeInImage),
                        maxWidth, maxHeight);
                // Store request in ImageView tag
                imageView.setTag(VideoContainer);
            } else {
    ...
    //Set
    public VideoContainer set(String requestUrl, ImageView imageView, Bitmap bitmap) {
        return set(requestUrl, imageView, 0, bitmap);
    }

    public VideoContainer set(String requestUrl, ImageView imageView, int placeHolderIndex, Bitmap bitmap) {
        return set(requestUrl, imageView, 
        		mPlaceHolderDrawables != null ? mPlaceHolderDrawables.get(placeHolderIndex) : null,
                mMaxImageWidth, mMaxImageHeight, bitmap);
    }

    public VideoContainer set(String requestUrl, ImageView imageView, Drawable placeHolder, Bitmap bitmap) {
        return set(requestUrl, imageView, placeHolder, mMaxImageWidth, mMaxImageHeight, bitmap);
    }

    public VideoContainer set(String requestUrl, ImageView imageView, Drawable placeHolder,
    ...
    private static VideoListener getVideoListener(final Resources resources,
    ...
    public interface ImageLoaderProvider {
        public SimpleVideoLoader getImageLoaderInstance();
    }
}