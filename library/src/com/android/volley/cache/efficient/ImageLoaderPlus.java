...
public class ImageLoaderPlus {
     ...
     */
    public ImageLoaderPlus(RequestQueue queue, File file) {
        this(queue, EfficientImageCache.getInstance(null, file));
    }
     ...
     * @param queue The RequestQueue to use for making image requests.
     */
    public ImageLoaderPlus(RequestQueue queue, FragmentManager manager, File file) {
        this(queue, EfficientImageCache.getInstance(manager, file));
    }
