 ...
 */
public class EfficientImageLoader extends ImageLoader {
	...
	public EfficientImageLoader setFadeInImage(boolean fadeInImage) {
        mFadeInImage = fadeInImage;
        return this;
    }

    public EfficientImageLoader setMaxImageSize(int maxImageWidth, int maxImageHeight) {
        mMaxImageWidth = maxImageWidth;
        mMaxImageHeight = maxImageHeight;
        return this;
    }

    public EfficientImageLoader setMaxImageSize(int maxImageSize) {
    ...
    public interface ImageLoaderProvider {
        public EfficientImageLoader getImageLoaderInstance();
    }
}